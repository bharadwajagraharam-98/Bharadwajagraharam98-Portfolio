...
export default function Experience() {
  return (
    <section id="experience" className="relative py-16 sm:py-28 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto z-10 relative">
        <SectionHeader label="Work History" title="Experience" />

        <div className="mt-12 sm:mt-16 relative">
          <div
            className="absolute left-4 sm:left-6 md:left-8 top-0 bottom-0 w-px"
            ...
            {resumeData.experience.map((job, i) => {
              ...
              return (
                <div key={i} className="relative pl-12 sm:pl-16 md:pl-20">
                  <div
                    className="absolute left-[10px] sm:left-[18px] md:left-[26px] top-1.5 w-5 h-5 rounded-full border-2 border-[#020617] flex items-center justify-center"
