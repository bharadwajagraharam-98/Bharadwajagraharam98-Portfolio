  ...
  return (
    <section id="contact" className="relative py-28 px-6">
      <div className="max-w-4xl mx-auto z-10 relative">
        ...
        <p className="text-slate-400 text-center text-lg max-w-xl mx-auto mt-6 mb-14 leading-relaxed">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="space-y-4">
            {[
              ...
              const inner = (
                <div
                  className="shimmer-card group flex items-center gap-4 p-5 rounded-2xl transition-all duration-300 hover:-translate-y-1"
                ...
                >
                  ...
                  {href && <ArrowRight size={14} className="text-slate-600 group-hover:text-slate-400 transition-colors" />}
                </div>
              );
              return href
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full rounded-xl px-4 py-3 text-slate-200 text-sm placeholder-slate-600 outline-none transition-all"
                style={inputStyle}
                onFocus={focusStyle}
                onBlur={blurStyle}
              />
            ...
            <div>
              ...
              <textarea
                ...
                required
                className="w-full rounded-xl px-4 py-3 text-slate-200 text-sm placeholder-slate-600 outline-none transition-all resize-none"
                style={inputStyle}
                onFocus={focusStyle}
                onBlur={blurStyle}
              />
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2.5 py-3.5 rounded-xl font-bold text-white transition-all duration-300 hover:-translate-y-1 disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:translate-y-0"
