...
export default function Projects() {
  return (
    <section id="projects" className="relative py-16 sm:py-28 px-4 sm:px-6">
              ...
              >
                ...
                <div className="flex items-start gap-3 sm:gap-4 mb-4 sm:mb-5">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="text-lg sm:text-xl font-bold text-white mb-1 leading-snug">{project.name}</h3>
