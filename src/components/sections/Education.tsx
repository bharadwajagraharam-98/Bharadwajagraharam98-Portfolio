...
export default function Education() {
  return (
    <section id="education" className="relative py-16 sm:py-24 lg:py-28 px-5 sm:px-8">
            ...
            return (
              ...
              >
                <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 rounded-xl flex items-center justify-center"
                  ...
                  <GraduationCap size={22} style={{ color: a.icon }} />
                </div>
                <div className="flex-grow min-w-0">
                  <h3 className="font-bold text-white mb-1 leading-snug" style={{ fontSize: 'clamp(1rem, 3vw, 1.25rem)' }}>
                    {edu.degree}
                  </h3>
